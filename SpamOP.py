...
def tv360(sdt):
    ...
    if response ['errorCode'] == 200:
        print(f'[BY: Sakuno] ~ \033[ TV360 SPAM THÀNH CÔNG')
    else:
        print(f'[BY: Sakuno] ~ \033[ TV360 SPAM THẤT BẠI')
def hoangphuc(sdt):
    headers = {
    ...
    if response ['success'] == True:
        print(f'[BY: Sakuno] ~ \033[  SPAM THÀNH CÔNG')
    else:
        print(f'[BY: Sakuno] ~ \033[ SPAM THẤT BẠI')
...
def fmplus(sdt):
    ...
    if response ['Code'] == 200:
        print(f'[BY: Sakuno] ~ \033[ FMPLUS SPAM THÀNH CÔNG')
    else:
        print(f'[BY: Sakuno] ~ \033[ FMPLUS SPAM THẤT BẠI')
...
def winmart(sdt):
    ...
    try:
        if response ['code'] == 'S200':
            print(f'[BY: Sakuno] ~ \033[ WINMART SPAM THÀNH CÔNG')
        else:
            print(f'[BY: Sakuno] ~ \033[ WINMART SPAM THẤT BẠI')
    except:
        print(f'[BY: Sakuno] ~ \033[ WINMART SPAM THẤT BẠI')
...
def gateway(sdt):
    ...
    if response ['code'] == 200:
        print(f'[BY: Sakuno] ~ \033[ GHN SPAM THÀNH CÔNG')
    else:
        print(f'[BY: Sakuno] ~ \033[ GHN SPAM THẤT BẠI')
def hine(sdt):
    headers = {
    ...
    if response ['success'] == True:
        print(f'[BY: Sakuno] ~ \033[ 30SHINE SPAM THÀNH CÔNG')
    else:
        print(f'[BY: Sakuno] ~ \033[ 30SHINE SPAM THẤT BẠI')
...
def medicare(sdt):
    ...
    try:
        if response ['error_code'] == 'fail':
            print(f'[BY: Sakuno] ~ \033[ MEDICARE SPAM THẤT BẠI')
        else:
            print(f'[BY: Sakuno] ~ \033[ MEDICARE SPAM THÀNH CÔNG')
    except:
        print(f'[BY: Sakuno] ~ \033[ MEDICARE SPAM THÀNH CÔNG')
...
def batdongsan(sdt):
    ...
    try:
        if response ['data'] == 'success':
            print(f'[BY: Sakuno] ~ \033[ BATDONGSAN SPAM THÀNH CÔNG')
        else:
            print(f'[BY: Sakuno] ~ \033[ BATDONGSAN SPAM THẤT BẠI')
    except:
        print(f'[BY: Sakuno] ~ \033[ BATDONGSAN SPAM THẤT BẠI')
...
def tokyolife(sdt):
    ...
    if response ['success'] == True:
        print(f'[BY: Sakuno] ~ \033[ TOKYOLIFE SPAM THÀNH CÔNG')
    else:
        print(f'[BY: Sakuno] ~ \033[ TOKYOLIFE SPAM THẤT BẠI')
...
def futabus(sdt):
    ...
    if response ['message'] == 'OK':
        print(f'[BY: Sakuno] ~ \033[ FUTABUS SPAM THÀNH CÔNG')
    else:
        print(f'[BY: Sakuno] ~ \033[ FUTABUS SPAM THẤT BẠI')
...
def thegioididong(sdt):
    ...
    if response ['statusCode'] == 200:
        print(f'[BY: Sakuno] ~ \033[ TGDĐ SPAM THÀNH CÔNG')
    else:
        print(f'[BY: Sakuno] ~ \033[ TGDĐ SPAM THẤT BẠI')
...
def kingfoodmart(sdt):
    ...
    if data2 == None:
        print(f'[BY: Sakuno] ~ \033[ KINGFOO SPAM THẤT BẠI')
    else:
        print(f'[BY: Sakuno] ~ \033[ KINGFOO SPAM THÀNH CÔNG')
...
def lottemart(sdt): # API lottemart CALL
    ...
    try:
        if response ['error'] == '':
            print("[BY: Sakuno] ~ \033[ LOTTEMART SPAM THÀNH CÔNG")
        else:
            print("[BY: Sakuno] ~ \033[ LOTTEMART SPAM THẤT BẠI")
    except:
        print("[BY: Sakuno] ~ \033[ LOTTEMART SPAM THẤT BẠI")
...
def dienmayxanh(sdt):
    ...
    # print(response)
    if response ['statusCode'] == 200:
        print("[BY: Sakuno] ~ \033[ ĐMX SPAM THÀNH CÔNG")
    else:
        print("[BY: Sakuno] ~ \033[ ĐMX SPAM THẤT BẠI")
...
def reebok(sdt):
    ...
    try:
        if response ['statusCode'] == 400:
            print(f'[BY: Sakuno] ~ \033[ REEBOK SPAM THẤT BẠI')
        else:
            print(f'[BY: Sakuno] ~ \033[ REEBOK SPAM THÀNH CÔNG')
    except:
        print(f'[BY: Sakuno] ~ \033[ REEBOK SPAM THÀNH CÔNG')
...
def glxplay(sdt):
    ...
    try:
        if response ['statusCode'] == 400:
            print(f'[BY: Sakuno] ~ \033[ GALAXY SPAM THẤT BẠI')
        else:
            print(f'[BY: Sakuno] ~ \033[ GALAXY SPAM THÀNH CÔNG')
    except:
        print(f'[BY: Sakuno] ~ \033[ GALAXY SPAM THÀNH CÔNG')
...
def fahasa(sdt):
    ...
    try:
        if response ['success'] == True:
            print(f'[BY: Sakuno] ~ \033[ FAHASA SPAM THÀNH CÔNG')
        else:
            print(f'[BY: Sakuno] ~ \033[ FAHASA SPAM THẤT BẠI')
    except:
        print(f'[BY: Sakuno] ~ \033[ FAHASA SPAM THẤT BẠI')
...
def nhathuoclongchau(sdt):
    ...
    try:
        ...
        if chi_mum == None:
            print(f'[BY: Sakuno] ~ \033[ NTLC SPAM THẤT BẠI')
        else:
            print(f'[BY: Sakuno] ~ \033[ NTLC SPAM THÀNH CÔNG')
    except:
        print(f'[BY: Sakuno] ~ \033[ NTLC SPAM THÀNH CÔNG')
...
def fptshop(sdt):
    ...
    try:
        chi_mum = response['error']['details']
        if chi_mum == None:
            print(f'[BY: Sakuno] ~ \033[ FPTSHOP SPAM THẤT BẠI')
        else:
            print(f'[BY: Sakuno] ~ \033[ FPTSHOP SPAM THÀNH CÔNG')
    except:
        print(f'[BY: Sakuno] ~ \033[ FPTSHOP SPAM THÀNH CÔNG')
...
def gumac(sdt):
    ...
    try:
        ...
        if data_cm == '':
            print(f'[BY: Sakuno] ~ \033[ GUMAC SPAM THÀNH CÔNG')
        else:
            print(f'[BY: Sakuno] ~ \033[ GUMAC SPAM THẤT BẠI')
    except:
        print(f'[BY: Sakuno] ~ \033[ GUMAC SPAM THẤT BẠI')
...
def vietloan(sdt):
    ...
    try:
        if response ['status'] == 'success':
            print(f'[BY: Sakuno] ~ \033[ VIETLOAN SPAM THÀNH CÔNG')
        else:
            print(f'[BY: Sakuno] ~ \033 VIETLOAN SPAM THẤT BẠI')
    except:
        print(f'[BY: Sakuno] ~ \033[VIETLOAN SPAM THẤT BẠI')
...
def viettel(sdt):
    ...
    try:
        if response ['errorCode'] == 0:
            print(f'[BY: Sakuno] ~ \033[ VIETTEL SPAM THÀNH CÔNG')
        else:
            print(f'[BY: Sakuno] ~ \033[VIETTEL SPAM THẤT BẠI')
    except:
        print(f'[BY: Sakuno] ~ \033[ VIETTEL SPAM THẤT BẠI')
...
def best(sdt):
    ...
    try:
        if response ['success'] == True:
            print(f'[BY: Sakuno] ~ \033[ BEST-INC SPAM THÀNH CÔNG')
        else:
            print(f'[BY: Sakuno] ~ \033[ BEST-INC SPAM THẤT BẠI')
    except:
        print(f'[BY: Sakuno] ~ \033[BEST-INC SPAM THẤT BẠI')
...
def emartmall(sdt):
    ...
    try:
        if response ['result'] == 'success':
            print(f'[BY: Sakuno] ~ \033[ EMARTMALL SPAM THÀNH CÔNG')
        else:
            print(f'[BY: Sakuno] ~ \033[ EMARTMALL SPAM THẤT BẠI')
    except:
        print(f'[BY: Sakuno ~ \033[ EMARTMALL SPAM THẤT BẠI')
...
def mutosi(sdt):
    ...
    try:
        if response ['status'] == 'error':
            print(f'[BY: Sakuno] ~ \033[ MUTOSI SPAM THẤT BẠI')
        else:
            print(f'[BY: Sakuno] ~ \033[ MUTOSI SPAM THÀNH CÔNG')
    except:
        print(f'[BY: Sakuno] ~ \033[ MUTOSI SPAM THÀNH CÔNG')
# \\ Vui lòng tôn trọng tác giả không xóa//
...
def vinamilk(sdt):
    ...
    print(f'[BY: Sakuno] ~ \033[ VINAMILK SPAM THÀNH CÔNG')
...
def vietair(sdt):
    ...
    try:
        if response ['TypeMsg'] == 1:
            print(f'[BY: Sakuno] ~ \033[ VIETAIR SPAM THÀNH CÔNG')
        else:
            print(f'[BY: Sakuno] ~ \033[ VIETAIR SPAM THẤT BẠI')
    except:
        print(f'[BY: Sakuno] ~ \033[ VIETAIR SPAM THẤT BẠI')
...
def sapo(sdt):
    ...
    try:
        if response == True:
            print(f'[BY: Sakuno] ~ \033[ SAPO SPAM THÀNH CÔNG')
        else:
            print(f'[BY: Sakuno] ~ \033[ SAPO SPAM THẤT BẠI')
    except:
        print(f'[BY: Sakuno] ~ \033[ SAPO SPAM THẤT BẠI')
